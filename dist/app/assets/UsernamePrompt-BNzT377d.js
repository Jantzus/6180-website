import{r as o,m as E,k as j,t as e,d as s,J as z,j as i,M as A,B as R,g as L,l as M}from"./buttons-CJB49aeq.js";import{U as C}from"./forms-DoOSyb7H.js";import{d as D,e as B}from"./UploadProgress-BL4GwvZb.js";const _=t=>{const[x,b]=o.useState(!1),[m,g]=o.useState(""),[f,c]=o.useState(""),[w,u]=o.useState(!1),[y,l]=o.useState(!1),$=o.useCallback(n=>{const a=/^[a-zA-Z0-9-]+$/.test(n);return console.log(`Username validation for '${n}': ${a}`),a},[]),p=o.useCallback(async(n,a)=>{var v,k;console.log(`Submitting username: ${n}`),l(!0),c("");const r=await E();if(!r){c(t("Authentication error. Please try again.")),l(!1);return}const h=`
