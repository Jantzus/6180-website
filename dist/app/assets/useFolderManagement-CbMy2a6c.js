import{r as f,L as V,h as M,f as D}from"./utils-BM__RYiI.js";import{F as Y}from"./types-CyPfckSQ.js";const X=h=>h.reduce((c,g)=>{const F=g.files.reduce((d,w)=>d+(w.dataInBytes||0),0);return c+F},0),ne=h=>{const[c,g]=f.useState([]),[F,d]=f.useState([]),[w,U]=f.useState(null),[v,B]=f.useState(null),[n,Q]=f.useState(""),[S,C]=f.useState(!1),[b,T]=f.useState(!1),[G,K]=f.useState(null),[j,k]=f.useState(0);f.useEffect(()=>{const e=X(c);k(e)},[c]);const x=async e=>{var r;try{const s=await(await fetch(D,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify({query:`
