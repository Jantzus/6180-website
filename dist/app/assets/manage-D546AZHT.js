import{d as b,j as t,x as U,m as Y,k as q,r as g,B as _,R as V,I as K,u as Z,a as Q,b as H,z as ee,g as te}from"./buttons-DmOL7fFv.js";import{u as re}from"./useFolderManagement-DcXHVPF-.js";import{a as J,I as ne,F as ie}from"./forms-B4HN34YU.js";import"./types-CyPfckSQ.js";const i={colors:{primary:"#007bff",success:"#4caf50",danger:"#e53935",warning:"#ff9800",white:"#fff",text:{primary:"#333",secondary:"#666"},background:{primary:"#f9fafb",highlight:"#f0f7ff"},border:"#ddd",grayLight:"#e0e0e0"},spacing:{sm:"8px",md:"16px",lg:"24px"},borderRadius:{small:"4px",medium:"8px"},boxShadow:{sm:"0 1px 2px rgba(0,0,0,0.06)",lg:"0 4px 10px rgba(0,0,0,0.08)"}},oe=b.div`
