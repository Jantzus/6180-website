...
`,ee=l.div`
  ...
  height: 100px;
  flex-shrink: 0;
`,Pe=({folders:o,setFolders:x,handleDeleteClick:f,openFilePicker:w,isUploading:v=!1,cognitoUsername:d,isProfileView:L=!1})=>{const{t:a,language:j}=te(),s=oe(j)==="rtl",c=y.useRef(null),[T,C]=y.useState({});y.useEffect(()=>{function e(){c.current&&(c.current.style.display="none",c.current=null)}function r(){e()}return window.addEventListener("scroll",r,!0),()=>{window.removeEventListener("scroll",r,!0)}},[]);const R=(e,r)=>{e.preventDefault(),e.stopPropagation(),c.current&&c.current!==r&&(c.current.style.display="none");const i=r.style.display==="block";r.style.display=i?"none":"block",c.current=i?null:r},$=e=>{c.current&&(c.current.style.display="none",c.current=null),window.confirm(a("Are you sure you want to delete this album? This action cannot be undone."))&&f&&f(e,a)},b=(e,r)=>{x&&x(i=>i.map(p=>p.folderId===e?{...p,profileIds:r}:p))},D=e=>{switch(e){case"NotVisible":return a("Hidden");case"Watermark":return a("Watermarked");case"CannotBeSaved":return a("Cannot be saved");case"NoPassword":default:return a("No password")}},A=(e,r)=>{const i=c.current&&c.current.style.display==="block",p=T[r]||!1;!i&&!p&&(window.location.href=e)},F=(e,r)=>{C(i=>({...i,[e]:r}))};return o.length===0&&!v?t.jsx(ce,{$type:"empty",children:t.jsx("p",{children:a("No albums found")})}):L?t.jsx(t.Fragment,{children:o.map(e=>{var p;const r=((p=e.folderPassword)==null?void 0:p.policy)||"NoPassword",i=M(e.folderId,e.albumNanoId||null,e.creatorId&&e.contacts&&e.contacts[e.creatorId],e.folderName);return t.jsx(W,{$isRTL:s,children:t.jsx(V,{onClick:()=>A(i,e.folderId),children:t.jsxs(G,{children:[t.jsx(U,{$isRTL:s,children:t.jsx(H,{$isRTL:s,children:t.jsx(Q,{children:e.folderName||""})})}),e.folderDescription&&e.folderDescription.length>1&&t.jsx(z,{$isRTL:s,children:e.folderDescription}),t.jsxs(q,{children:[t.jsx(J,{$isRTL:s,children:e.files.map((h,g)=>t.jsx(ee,{children:t.jsx(O,{thumbnailDataKey:h.thumbnailDataKey,dataKey:h.dataKey,src:`${K}${h.thumbnailDataKey||h.dataKey}`,alt:a("Thumbnail"),style:{width:"100%",height:"100%",objectFit:"cover",borderRadius:6,border:"1px solid #ddd"}})},g))}),e.files.length>3&&t.jsx(X,{$isRTL:s})]}),t.jsx(Z,{$isRTL:s,children:r!=="NoPassword"&&t.jsx(E,{children:t.jsx("span",{children:D(r)})})})]})})},e.folderId)})}):t.jsx(t.Fragment,{children:o.map(e=>{var k;const r=e.createdAt!=null,i=e.updatedAt!=null&&e.createdAt!=null&&e.updatedAt!==e.createdAt,p=e.creatorId===`${d}_____${d}____Account`,h=((k=e.folderPassword)==null?void 0:k.policy)||"NoPassword",g=e.contacts||{},m=Object.values(g).filter(n=>n&&typeof n=="string"&&!n.toString().startsWith("Profile-")),u=xe(e.files),I=M(e.folderId,e.albumNanoId||null,e.creatorId&&e.contacts&&e.contacts[e.creatorId],e.folderName);return t.jsx(W,{$isRTL:s,children:t.jsx(V,{onClick:()=>A(I,e.folderId),children:t.jsxs(G,{children:[t.jsxs(U,{$isRTL:s,children:[t.jsxs(H,{$isRTL:s,children:[t.jsx(Q,{children:e.folderName||""}),(r||i)&&t.jsxs(pe,{$isRTL:s,children:[r&&e.createdAt&&_(e.createdAt)&&t.jsxs("div",{children:[a("Created"),": ",_(e.createdAt)]}),i&&e.updatedAt&&_(e.updatedAt)&&t.jsxs("div",{children:[a("Updated"),": ",_(e.updatedAt)]})]})]}),t.jsx(fe,{$isRTL:s,children:p?t.jsxs(be,{children:[t.jsx(ge,{onClick:n=>{const P=n.currentTarget.nextElementSibling;P&&R(n,P)},children:a("Edit")}),t.jsxs(ye,{$isRTL:s,onClick:n=>{n.stopPropagation()},children:[t.jsx(Y,{$isRTL:s,onClick:n=>{n.stopPropagation(),window.location.href=re(`save-album.html?folderId=${encodeURIComponent(e.folderId)}`)},children:a("Edit Details")}),t.jsx(Y,{$isRTL:s,$isDelete:!0,onClick:n=>{n.preventDefault(),n.stopPropagation(),$(e.folderPositionId)},children:a("Delete My Copy")})]})]}):t.jsx(me,{onClick:n=>{n.preventDefault(),n.stopPropagation(),$(e.folderPositionId)},children:a("Delete My Copy")})})]}),e.folderDescription&&e.folderDescription.length>1&&t.jsx(z,{$isRTL:s,children:e.folderDescription}),t.jsx(ue,{$isRTL:s,children:e.files.length===1?`${a("{{count}} file",{count:e.files.length.toString()})} • ${B(u)}`:`${a("{{count}} files",{count:e.files.length.toString()})} • ${B(u)}`}),t.jsxs(q,{children:[t.jsx(J,{$isRTL:s,children:e.files.map((n,P)=>t.jsx(ee,{children:t.jsx(O,{thumbnailDataKey:n.thumbnailDataKey,dataKey:n.dataKey,src:`${K}${n.thumbnailDataKey||n.dataKey}`,alt:a("Thumbnail"),style:{width:"100%",height:"100%",objectFit:"cover",borderRadius:6,border:"1px solid #ddd"}})},P))}),e.files.length>3&&t.jsx(X,{$isRTL:s})]}),t.jsx(Z,{$isRTL:s,children:h!=="NoPassword"&&t.jsx(E,{children:t.jsx("span",{children:D(h)})})}),L==!1&&t.jsx(he,{folder:e,openFilePicker:w,cognitoUsername:d,updateProfileIds:n=>b(e.folderId,n),onModalStateChange:n=>F(e.folderId,n)}),m.length>0&&t.jsx(we,{$isRTL:s,children:t.jsxs($e,{$isRTL:s,children:[a("Shared with"),": ",m.join(", ")]})})]})})},e.folderId)})})};export{Pe as A};
