...
`,U=l.div`
  ...
  height: 100px;
  flex-shrink: 0;
`,Ie=({folders:o,setFolders:y,handleDeleteClick:f,openFilePicker:u,isUploading:i=!1,cognitoUsername:x,isProfileView:b=!1})=>{const{t:a,language:I}=Z(),s=ee(I)==="rtl",p=w.useRef(null);w.useEffect(()=>{function e(){p.current&&(p.current.style.display="none",p.current=null)}function r(){e()}return window.addEventListener("scroll",r,!0),()=>{window.removeEventListener("scroll",r,!0)}},[]);const L=(e,r)=>{e.preventDefault(),e.stopPropagation(),p.current&&p.current!==r&&(p.current.style.display="none");const g=r.style.display==="block";r.style.display=g?"none":"block",p.current=g?null:r},j=e=>{p.current&&(p.current.style.display="none",p.current=null),window.confirm(a("Are you sure you want to delete this album? This action cannot be undone."))&&f&&f(e,a)},C=(e,r)=>{y&&y(g=>g.map(m=>m.folderId===e?{...m,profileIds:r}:m))},v=e=>{switch(e){case"NotVisible":return a("Hidden");case"Watermark":return a("Watermarked");case"CannotBeSaved":return a("Cannot be saved");case"NoPassword":default:return a("No password")}};return o.length===0&&!i?t.jsx(le,{type:"empty",children:t.jsx("p",{children:a("No albums found")})}):b?t.jsx(t.Fragment,{children:o.map(e=>{var m;const r=((m=e.folderPassword)==null?void 0:m.policy)||"NoPassword",g=_(e.folderId,e.albumNanoId||null,e.creatorId&&e.contacts&&e.contacts[e.creatorId],e.folderName);return t.jsx(W,{isRTL:s,children:t.jsx(B,{href:g,children:t.jsxs(K,{children:[t.jsx(M,{isRTL:s,children:t.jsx(G,{isRTL:s,children:t.jsx(H,{children:e.folderName||""})})}),e.folderDescription&&e.folderDescription.length>1&&t.jsx(z,{isRTL:s,children:e.folderDescription}),t.jsxs(Y,{children:[t.jsx(q,{isRTL:s,children:e.files.map((h,d)=>t.jsx(U,{children:t.jsx(O,{thumbnailDataKey:h.thumbnailDataKey,dataKey:h.dataKey,src:`${$}${h.thumbnailDataKey||h.dataKey}`,alt:a("Thumbnail"),style:{width:"100%",height:"100%",objectFit:"cover",borderRadius:6,border:"1px solid #ddd"}})},d))}),e.files.length>3&&t.jsx(J,{isRTL:s})]}),t.jsx(X,{isRTL:s,children:r!=="NoPassword"&&t.jsx(E,{children:t.jsx("span",{children:v(r)})})})]})})},e.folderId)})}):t.jsx(t.Fragment,{children:o.map(e=>{var S;const r=e.createdAt!=null,g=e.updatedAt!=null&&e.createdAt!=null&&e.updatedAt!==e.createdAt,m=e.creatorId===`${x}_____${x}____Account`,h=((S=e.folderPassword)==null?void 0:S.policy)||"NoPassword",d=e.contacts||{},P=Object.values(d).filter(n=>n&&typeof n=="string"&&!n.toString().startsWith("Profile-")),k=_(e.folderId,e.albumNanoId||null,e.creatorId&&e.contacts&&e.contacts[e.creatorId],e.folderName);return t.jsx(W,{isRTL:s,children:t.jsx(B,{href:k,children:t.jsxs(K,{children:[t.jsxs(M,{isRTL:s,children:[t.jsxs(G,{isRTL:s,children:[t.jsx(H,{children:e.folderName||""}),(r||g)&&t.jsxs(de,{isRTL:s,children:[r&&e.createdAt&&R(e.createdAt)&&t.jsxs("div",{children:[a("Created"),": ",R(e.createdAt)]}),g&&e.updatedAt&&R(e.updatedAt)&&t.jsxs("div",{children:[a("Updated"),": ",R(e.updatedAt)]})]})]}),t.jsx(pe,{isRTL:s,children:m?t.jsxs(ue,{children:[t.jsx(he,{href:"#",onClick:n=>{const c=n.currentTarget.nextElementSibling;c&&L(n,c)},children:a("Edit")}),t.jsxs(ge,{isRTL:s,onClick:n=>{n.stopPropagation()},children:[t.jsx(Q,{href:ie(`save-album.html?folderId=${encodeURIComponent(e.folderId)}`),onClick:n=>{n.stopPropagation()},children:a("Edit Details")}),t.jsx(Q,{href:"#",isDelete:!0,onClick:n=>{n.preventDefault(),n.stopPropagation(),j(e.folderPositionId)},children:a("Delete My Copy")})]})]}):t.jsx(xe,{href:"#",onClick:n=>{n.preventDefault(),n.stopPropagation(),j(e.folderPositionId)},children:a("Delete")})})]}),e.folderDescription&&e.folderDescription.length>1&&t.jsx(z,{isRTL:s,children:e.folderDescription}),t.jsx(ce,{isRTL:s,children:e.files.length===1?a("{count} file").replace("{count}",e.files.length.toString()):a("{count} files").replace("{count}",e.files.length.toString())}),t.jsxs(Y,{children:[t.jsx(q,{isRTL:s,children:e.files.map((n,c)=>t.jsx(U,{children:t.jsx(O,{thumbnailDataKey:n.thumbnailDataKey,dataKey:n.dataKey,src:`${$}${n.thumbnailDataKey||n.dataKey}`,alt:a("Thumbnail"),style:{width:"100%",height:"100%",objectFit:"cover",borderRadius:6,border:"1px solid #ddd"}})},c))}),e.files.length>3&&t.jsx(J,{isRTL:s})]}),t.jsx(X,{isRTL:s,children:h!=="NoPassword"&&t.jsx(E,{children:t.jsx("span",{children:v(h)})})}),b==!1&&V&&t.jsx(V,{folder:e,openFilePicker:u,cognitoUsername:x,updateProfileIds:n=>C(e.folderId,n)}),P.length>0&&t.jsx(fe,{isRTL:s,children:t.jsxs(be,{isRTL:s,children:[a("Shared with"),": ",P.join(", ")]})})]})})},e.folderId)})})};export{Ie as A,O as L,ve as S};
