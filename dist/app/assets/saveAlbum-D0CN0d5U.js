import{d as z,u as Ke,a as y,j as t,g as Ie,h as de,L as me,i as Fe,s as $t,m as Tt,f as ye,k as vt,l as It,n as Pt,r as At,R as kt,I as jt,p as Ct}from"./utils-B5IJzCfT.js";import{C as Pe,F as _e,e as Ee,f as Dt,g as Ft,T as Ne,h as Re,i as Oe,j as ze,P as _t,k as Et,l as Ge,m as qe,n as Nt,o as Rt,S as Ot,p as zt,V as Bt,q as Mt,r as Ut,M as Wt,G as Kt,A as Gt,H as qt,s as Ht,t as Jt,B as ve}from"./styled-components-DYsn5kNr.js";import{u as Qt,U as Vt}from"./useUsernameManagement-CoviZPKK.js";import{u as Yt,U as Xt}from"./useFileUploadProcessor-B6R1EqTu.js";import{F as Zt}from"./types-B2_92tNb.js";import{L as Lt}from"./LogoutButton-AQ71X0ke.js";import{L as es}from"./LazyImage-BhJb7zUu.js";const d={colors:{primary:"#007bff",primaryDark:"#0056b3",secondary:"#6c757d",success:"#4caf50",danger:"#e53935",warning:"#ff9800",white:"#fff",text:{primary:"#333",secondary:"#666",light:"#777"},background:{primary:"#f9fafb",highlight:"#f0f7ff"},border:"#ddd"},spacing:{xs:"4px",sm:"8px",md:"16px",lg:"24px",xl:"32px"},borderRadius:{small:"4px",medium:"8px"},boxShadow:{lg:"0 4px 10px rgba(0,0,0,0.08)"}},ts=z.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,zs=z.span`
  ...
  font-size: 10px;
  font-weight: bold;
`,Bs=({tag:e,isSelected:n,isDisplayed:i,isBeingDeleted:S,disabled:p,onTagClick:I,onDeleteTag:c,getTagDisplayText:v})=>{const[g,$]=y.useState(!1);return t.jsxs(Ve,{$isSelected:n,$isDisplayed:i,$isBeingDeleted:S,disabled:p,onClick:()=>I(e),onMouseEnter:()=>$(!0),onMouseLeave:()=>$(!1),children:[v(e),g&&!p&&!S&&t.jsx(Ye,{onClick:W=>{W.stopPropagation(),c(e.id)},disabled:S,children:"×"})]})},Ms=({subtag:e,isSelected:n,isBeingDeleted:i,disabled:S,onSubtagClick:p,onDeleteSubtag:I})=>{const[c,v]=y.useState(!1);return t.jsxs(Es,{$isSelected:n,$isBeingDeleted:i,disabled:S,onClick:()=>p(e),onMouseEnter:()=>v(!0),onMouseLeave:()=>v(!1),children:[e.subtagTitle,c&&!S&&!i&&t.jsx(Ye,{onClick:g=>{g.stopPropagation(),I(e.id)},disabled:i,children:"×"})]})},Le=({value:e,onChange:n,onSubmit:i,onCancel:S,isSubmitting:p,placeholder:I="Enter tag name..."})=>{const c=y.useRef(null);y.useEffect(()=>{c.current&&c.current.focus()},[]);const v=g=>{g.key==="Enter"?i():g.key==="Escape"&&S()};return t.jsxs(Rs,{children:[t.jsx(Os,{ref:c,type:"text",value:e,onChange:g=>n(g.target.value),onKeyDown:v,placeholder:I,disabled:p}),t.jsx(We,{onClick:i,disabled:!e.trim()||p,title:"Add (Enter)",children:p?"...":"✓"}),t.jsx(We,{onClick:S,disabled:p,title:"Cancel (Escape)",children:"×"})]})},Us=({tagsManager:e,disabled:n=!1,enhancedLog:i,photoCount:S=1})=>{const{tags:p,selectedTags:I,displayedTagId:c,isLoadingTags:v,tagIdBeingDeleted:g,isAddingNewTag:$,newTagTitle:W,isSubmittingNewTag:u,selectTag:o,unselectTag:H,setDisplayedTag:q,isTagSelected:j,deleteTag:s,startAddingNewTag:Z,cancelAddingNewTag:X,submitNewTag:L,setNewTagTitle:V}=e,ae=m=>{if(n)return;const U=j(m),O=c===m.id;U?U&&!O?(q(m.id),i(`Displayed tag: ${m.tagTitle}`)):U&&O&&(H(m),q(null),i(`Unselected tag: ${m.tagTitle}`)):(o(m),q(m.id),i(`Selected tag for photo application: ${m.tagTitle}`))},D=async m=>{if(n)return;i(`Delete tag initiated: ${m}`);const U=await s(m);i(U?`Tag successfully deleted: ${m}`:`Failed to delete tag: ${m}`)},l=async()=>{await L()||i("Failed to submit new tag")},B=m=>{const U=I.find(ee=>ee.tagTitle===m.tagTitle);if(!U||U.subtags.length===0)return m.tagTitle;const O=U.subtags.map(ee=>ee.subtagTitle).join(" || ");return`${m.tagTitle}  |  ${O}`},F=[...p].sort((m,U)=>m.points!==U.points?U.points-m.points:U.updatedAt-m.updatedAt);return t.jsxs(_s,{children:[t.jsxs(He,{children:[t.jsxs(Je,{children:["Select Tags to Apply to Photos",I.length>0&&t.jsxs(zs,{children:[I.length," selected"]})]}),t.jsx(Qe,{children:v?t.jsx(Ns,{children:"Loading tags..."}):t.jsxs(t.Fragment,{children:[F.map(m=>t.jsx(Bs,{tag:m,isSelected:j(m),isDisplayed:c===m.id,isBeingDeleted:g===m.id,disabled:n,onTagClick:ae,onDeleteTag:D,getTagDisplayText:B},m.id)),$?t.jsx(Le,{value:W,onChange:V,onSubmit:l,onCancel:X,isSubmitting:u,placeholder:"Enter tag name..."}):t.jsx(Ze,{disabled:n,onClick:Z,children:"+ Add Tag"}),F.length===0&&!$&&t.jsx(Xe,{children:"No tags available"})]})})]}),c&&t.jsx(Ws,{tagsManager:e,disabled:n,enhancedLog:i}),I.length>0&&t.jsxs("div",{style:{marginTop:"12px",padding:"12px 16px",background:"#e7f3ff",borderRadius:"6px",fontSize:"13px",color:"#0c5aa6",border:"1px solid #b3d9ff"},children:[t.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",marginBottom:"6px"},children:[t.jsx("span",{children:"🎯"}),t.jsx("strong",{children:"Ready to Apply Tags:"})]}),"You have selected ",t.jsxs("strong",{children:[I.length," tag",I.length!==1?"s":""]})," to apply to photos.",t.jsx("br",{}),t.jsx("strong",{children:"Next:"})," ",S===1?'Click "Apply Selected Tags to Photo" above to tag your photo.':`Select photos above (they'll show blue borders), then click "Apply Selected Tags to Photos".`]})]})},Ws=({tagsManager:e,disabled:n=!1,enhancedLog:i})=>{var D;const{displayedTagId:S,subtagIdBeingDeleted:p,isAddingNewSubtag:I,newSubtagTitle:c,isSubmittingNewSubtag:v,selectSubtag:g,unselectSubtag:$,isSubtagSelected:W,deleteSubtag:u,startAddingNewSubtag:o,cancelAddingNewSubtag:H,submitNewSubtag:q,setNewSubtagTitle:j}=e,s=S?((D=e.tags.find(l=>l.id===S))==null?void 0:D.subtags)||[]:[],Z=e.tags.find(l=>l.id===S),X=l=>{if(n)return;W(l)?($(l),i(`Unselected subtag for photo application: ${l.subtagTitle}`)):(g(l),i(`Selected subtag for photo application: ${l.subtagTitle}`))},L=async l=>{if(n)return;i(`Delete subtag initiated: ${l}`);const B=await u(l);i(B?`Subtag successfully deleted: ${l}`:`Failed to delete subtag: ${l}`)},V=async()=>{await q()||i("Failed to submit new subtag")};if(!Z)return null;const ae=[...s].sort((l,B)=>l.points!==B.points?B.points-l.points:B.updatedAt-l.updatedAt);return t.jsxs(He,{children:[t.jsxs(Je,{children:['Subtags for "',Z.tagTitle,'"']}),t.jsxs(Qe,{children:[ae.map(l=>t.jsx(Ms,{subtag:l,isSelected:W(l),isBeingDeleted:p===l.id,disabled:n,onSubtagClick:X,onDeleteSubtag:L},l.id)),I?t.jsx(Le,{value:c,onChange:j,onSubmit:V,onCancel:H,isSubmitting:v,placeholder:"Enter subtag name..."}):t.jsx(Ze,{disabled:n,onClick:o,children:"+ Add Subtag"}),ae.length===0&&!I&&t.jsx(Xe,{children:"No subtags available"})]})]})},Ks=({children:e,t:n,isRTL:i})=>t.jsxs("div",{style:{padding:"24px",marginBottom:"24px",backgroundColor:"#f8f9fa",border:"2px solid #e9ecef",borderRadius:"12px",direction:i?"rtl":"ltr"},children:[t.jsxs("div",{style:{display:"flex",alignItems:"center",fontSize:"18px",color:"#495057",fontWeight:"600",marginBottom:"20px",flexDirection:i?"row-reverse":"row"},children:[t.jsx("span",{style:{marginRight:i?"0":"12px",marginLeft:i?"12px":"0",fontSize:"20px"},children:"📷"}),n("Click files below to select them for tagging")]}),e]}),Gs=({selectedPhotos:e,selectedPhotoIndices:n,onToggleSelection:i,onSelectAll:S,onDeselectAll:p,onRemovePhoto:I,disabled:c,t:v,isRTL:g})=>e.length===0?null:t.jsxs("div",{style:{marginBottom:"24px",direction:g?"rtl":"ltr"},children:[t.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px",flexDirection:g?"row-reverse":"row"},children:[t.jsxs("h3",{style:{fontSize:"16px",fontWeight:"600",color:"#333",margin:0},children:[v("New Files")," (",e.length,")"]}),t.jsx("div",{style:{display:"flex",gap:"8px",flexDirection:g?"row-reverse":"row"},children:t.jsx("button",{style:{padding:"6px 12px",fontSize:"12px",border:"1px solid #ddd",borderRadius:"4px",backgroundColor:c?"#f8f9fa":"#fff",color:c?"#999":"#333",cursor:c?"not-allowed":"pointer",transition:"all 0.2s ease"},onClick:n.size===e.length?p:S,disabled:c,onMouseEnter:$=>{c||($.currentTarget.style.backgroundColor="#f8f9fa")},onMouseLeave:$=>{c||($.currentTarget.style.backgroundColor="#fff")},children:n.size===e.length?v("Deselect All"):v("Select All")})})]}),t.jsx(vs,{selectedPhotos:e,selectedPhotoIndices:n,isSavingAlbum:c,onRemovePhoto:I,onTogglePhotoSelection:i,onSelectAllPhotos:S,onDeselectAllPhotos:p,hideHeader:!0})]}),qs=({existingFiles:e,selectedExistingIndices:n,onToggleSelection:i,onSelectAll:S,onDeselectAll:p,onDeleteFile:I,disabled:c,t:v,isRTL:g})=>e.length===0?null:t.jsxs("div",{style:{marginBottom:"24px",direction:g?"rtl":"ltr"},children:[t.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px",flexDirection:g?"row-reverse":"row"},children:[t.jsxs("h3",{style:{fontSize:"16px",fontWeight:"600",color:"#333",margin:0},children:[v("Existing Files")," (",e.length,")"]}),t.jsx("div",{style:{display:"flex",gap:"8px",flexDirection:g?"row-reverse":"row"},children:t.jsx("button",{style:{padding:"6px 12px",fontSize:"12px",border:"1px solid #ddd",borderRadius:"4px",backgroundColor:c?"#f8f9fa":"#fff",color:c?"#999":"#333",cursor:c?"not-allowed":"pointer",transition:"all 0.2s ease"},onClick:n.size===e.length?p:S,disabled:c,onMouseEnter:$=>{c||($.currentTarget.style.backgroundColor="#f8f9fa")},onMouseLeave:$=>{c||($.currentTarget.style.backgroundColor="#fff")},children:n.size===e.length?v("Deselect All"):v("Select All")})})]}),t.jsx("div",{style:{display:"flex",overflowX:"auto",gap:"12px",padding:"16px",border:"2px dashed #007bff",borderRadius:"8px",backgroundColor:"#fff",scrollbarWidth:"thin",scrollbarColor:"#007bff #f8f9fa"},children:e.map(($,W)=>t.jsxs("div",{style:{position:"relative",width:"160px",height:"160px",flexShrink:0,borderRadius:"8px",overflow:"hidden",border:n.has(W)?"3px solid #007bff":"2px solid #ddd",cursor:c?"not-allowed":"pointer",opacity:c?.6:1,transition:"all 0.2s ease"},onClick:()=>!c&&i(W),children:[t.jsx(es,{thumbnailDataKey:$.thumbnailDataKey,dataKey:$.dataKey,alt:v("Existing file"),style:{width:"100%",height:"100%",objectFit:"cover"}}),n.has(W)&&t.jsx("div",{style:{position:"absolute",bottom:"8px",left:"8px",right:"8px",background:"rgba(0, 123, 255, 0.9)",color:"white",padding:"4px 8px",borderRadius:"4px",fontSize:"11px",fontWeight:"bold",textAlign:"center",zIndex:10},children:"SELECTED FOR TAGGING"}),t.jsx("button",{onClick:u=>{u.stopPropagation(),!c&&confirm(v("Are you sure you want to remove this file?"))&&I(W)},disabled:c,style:{position:"absolute",top:"8px",right:"8px",width:"24px",height:"24px",borderRadius:"50%",border:"none",backgroundColor:"rgba(220, 53, 69, 0.9)",color:"white",cursor:c?"not-allowed":"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"14px",fontWeight:"900",zIndex:20,opacity:c?.5:1,transition:"all 0.2s ease",boxShadow:"0 2px 4px rgba(0,0,0,0.3)",lineHeight:"1"},onMouseEnter:u=>{c||(u.currentTarget.style.backgroundColor="rgba(200, 35, 51, 1)",u.currentTarget.style.transform="scale(1.1)")},onMouseLeave:u=>{c||(u.currentTarget.style.backgroundColor="rgba(220, 53, 69, 0.9)",u.currentTarget.style.transform="scale(1)")},title:v("Remove file"),children:"×"}),$.dataInBytes>0&&t.jsxs("div",{style:{position:"absolute",bottom:"4px",left:"4px",backgroundColor:"rgba(0,0,0,0.7)",color:"white",fontSize:"10px",padding:"2px 4px",borderRadius:"4px"},children:[($.dataInBytes/(1024*1024)).toFixed(1),"MB"]}),$.durationInSeconds&&t.jsxs("div",{style:{position:"absolute",top:"8px",left:"8px",backgroundColor:"rgba(0,0,0,0.7)",color:"white",fontSize:"10px",padding:"2px 4px",borderRadius:"4px"},children:[Math.floor($.durationInSeconds/60),":",String(Math.floor($.durationInSeconds%60)).padStart(2,"0")]})]},`existing-${W}-${$.dataKey}`))})]}),Hs=()=>{const{t:e,language:n}=Ke(),i=Ie(n)==="rtl",S=Qt(e),{setShowUsernamePrompt:p,setUsernameInput:I}=S,[c,v]=y.useState(null),[g,$]=y.useState(!1),[W,u]=y.useState(0),[o,H]=y.useState(""),[q,j]=y.useState(""),[s,Z]=y.useState(!1),[X,L]=y.useState(!1),[V,ae]=y.useState("NoPassword"),[D,l]=y.useState(""),[B,F]=y.useState(!1),[m,U]=y.useState(!0),[O,ee]=y.useState(null),[fe,x]=y.useState(!1),[b,_]=y.useState([]),[h,C]=y.useState(new Set),[T,E]=y.useState(new Map),[P,M]=y.useState([]),[J,ie]=y.useState(new Set),[oe,pe]=y.useState(new Map),[ce,ue]=y.useState(!1),be=a=>{!c&&a&&v(a)},{fileInputRef:r,selectedPhotos:f,setSelectedPhotos:A,isUploading:Q,progressTracker:K,setProgressTracker:se,debugMessages:te,currentFolderId:Y,openFilePicker:le,handleFileSelection:xe,setEditingExistingAlbum:ge,log:Se}=Yt(be,!0);y.useEffect(()=>{(async()=>{try{await Ct(),Se("🔥 Save-album page S3 credentials prewarmed successfully")}catch(w){Se(`⚠️ Save-album page credential prewarming failed: ${String(w)}`)}})()},[]);const k=(a,w)=>{let R=`[${new Date().toISOString()}] ${a}`;if(w!==void 0)try{const G=typeof w=="object"?JSON.stringify(w,null,2):String(w);R+=`
Data: ${G}`,console.log(R),console.log("Data object:",w)}catch(G){R+=` [Error stringifying data: ${G}]`,console.log(R),console.log("Raw data:",w)}else console.log(R);Se(R)},et=async a=>{var w,N,R,G;if(a){ue(!0),k(`Fetching existing album data for folder ID: ${a}`);try{const re=await de();if(!re){k("❌ Authentication failed while fetching existing album data");return}const yt=`
      ...
      `,St={fetchRelationsInput:{ownerItemId:"myAccountOwnerItemId",rangeKeyPrefix:"FolderPosition",index:"ownerItemId_____RelationType____sortParameter",limit:2e3,scanIndexForward:!1}},we=await(await fetch(ye,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${re}`},body:JSON.stringify({query:yt,variables:St})})).json();if(we.errors){console.error("GraphQL errors:",we.errors),k(`❌ Failed to fetch existing album data: ${JSON.stringify(we.errors)}`);return}const Ce=(((N=(w=we==null?void 0:we.data)==null?void 0:w.fetchRelations)==null?void 0:N.items)||[]).find(ne=>ne&&ne.folder&&ne.folder.id===a);if(!Ce)return;const he=Ce.folder,De=(((G=(R=he==null?void 0:he.fileReferencesPage)==null?void 0:R.items)==null?void 0:G.map(ne=>ne.file))||[]).filter(ne=>ne&&ne.dataKey).map(ne=>({dataKey:ne.dataKey,thumbnailDataKey:ne.thumbnailDataKey||null,durationInSeconds:ne.durationInSeconds||null,dataInBytes:ne.dataInBytes||0}));M(De),k(`✅ Successfully loaded ${De.length} existing files`),!o&&he.folderName&&H(he.folderName),!q&&he.folderDescription&&j(he.folderDescription),ge(a)}catch(re){console.error("Failed to fetch existing album data:",re),k(`❌ Failed to fetch existing album data: ${String(re)}`)}finally{ue(!1)}}};y.useEffect(()=>{c&&c!==Y&&(k(`Loading existing files for folder ID: ${c}`),et(c))},[c,Y]);const tt=Fs(k),{cognitoUsername:ke,publicUsername:$e,setPublicUsername:st}=$s(v,A,ee,Z,H,j,F,U,ae,l,x,_,k),{saveAlbumDirectly:je}=Ts(c||Y,ke,f,fe,b,o,q,B,m,V,D,T,$,u,A,se,k);y.useEffect(()=>{Y&&!c&&(v(Y),k(`Updated folder ID from upload processor: ${Y}`))},[Y,c]),y.useEffect(()=>{C(a=>{const w=new Set;return a.forEach(N=>{N<f.length&&w.add(N)}),w}),E(a=>{const w=new Map(a),N=[];return a.forEach((R,G)=>{G>=f.length&&N.push(G)}),N.forEach(R=>{w.delete(R)}),w})},[f.length]),y.useEffect(()=>{ie(a=>{const w=new Set;return a.forEach(N=>{N<P.length&&w.add(N)}),w}),pe(a=>{const w=new Map(a),N=[];return a.forEach((R,G)=>{G>=P.length&&N.push(G)}),N.forEach(R=>{w.delete(R)}),w})},[P.length]);const rt=a=>{k(`Removing photo at index: ${a}`);const w=f.filter((N,R)=>R!==a);A(w),k(`New files count: ${w.length}`),w.length>0?(localStorage.setItem(me.SELECTED_PHOTOS,JSON.stringify(w)),k(`Updated localStorage with ${w.length} photos`)):(localStorage.removeItem(me.SELECTED_PHOTOS),k("Removed photos from localStorage")),C(N=>{const R=new Set;return N.forEach(G=>{G<a?R.add(G):G>a&&R.add(G-1)}),R}),E(N=>{const R=new Map;return N.forEach((G,re)=>{re<a?R.set(re,G):re>a&&R.set(re-1,G)}),R})},it=a=>{k(`Removing existing file at index: ${a}`);const w=P.filter((N,R)=>R!==a);M(w),k(`New existing files count: ${w.length}`),ie(N=>{const R=new Set;return N.forEach(G=>{G<a?R.add(G):G>a&&R.add(G-1)}),R}),pe(N=>{const R=new Map;return N.forEach((G,re)=>{re<a?R.set(re,G):re>a&&R.set(re-1,G)}),R})},ot=a=>{k(`Toggling selection for existing file at index: ${a}`),ie(w=>{const N=new Set(w);return N.has(a)?(N.delete(a),k(`Deselected existing file ${a}`)):(N.add(a),k(`Selected existing file ${a}`)),N})},at=()=>{k("Selecting all existing files");const a=new Set;for(let w=0;w<P.length;w++)a.add(w);ie(a)},nt=()=>{k("Deselecting all existing files"),ie(new Set)},lt=a=>{k(`Toggling selection for photo at index: ${a}`),C(w=>{const N=new Set(w);return N.has(a)?(N.delete(a),k(`Deselected photo ${a}`)):(N.add(a),k(`Selected photo ${a}`)),N})},dt=()=>{k("Selecting all photos");const a=new Set;for(let w=0;w<f.length;w++)a.add(w);C(a)},ct=()=>{k("Deselecting all photos"),C(new Set)},ut=()=>{const a=!B;k(`Toggling isOnPublicProfile to: ${a}`),F(a)},pt=()=>{const a=!m;k(`Toggling participantsCanAddItems to: ${a}`),U(a)},ft=async()=>{k("Album save initiated"),k("Photo tags applied:",Object.fromEntries(T)),k("Existing file tags applied:",Object.fromEntries(oe)),$(!0);try{if($e!=null&&$e.startsWith("Profile-")){k("Public username starts with 'Profile-', showing username prompt"),I(""),p(!0),$(!1);return}k("Valid username found, proceeding to save album directly with file-level tagging"),je()}catch(a){console.error("Error in handleSaveAlbum:",a),k(`Error in handleSaveAlbum: ${a}`),$(!1)}},gt=a=>{k(`Handling successful username update to: ${a}`),localStorage.setItem(me.PUBLIC_USERNAME,a),st(a),p(!1),k("Proceeding to save album after username update"),je()},mt=(a,w)=>{k(`Password dialog closed with option: ${a}, password: ${w?"******":"undefined"}`),a&&ae(a),w!==void 0&&l(w),L(!1)},xt=()=>V==="NoPassword"?e("Album Password Policy"):`${e(V==="NotVisible"?"Password Required To See Or Save":V==="Watermark"?"Watermarked And No Saving Without Password":"Password Required To Save")} ${D?`(${D})`:""}`,ht=()=>{k("Opening password dialog"),L(!0)},bt=()=>{k("Add photos button clicked"),le(c)},Te=g||Q||ce,wt=f.length>0||P.length>0;return t.jsxs(t.Fragment,{children:[t.jsx(Kt,{}),t.jsxs(Gt,{$isRTL:i,children:[t.jsxs("div",{style:{maxWidth:"900px",margin:"0 auto"},children:[t.jsxs(qt,{children:[t.jsx(Ht,{href:"my-albums.html",children:e("My Albums")}),t.jsx(Lt,{t:e})]}),t.jsx(Ps,{showFolderDetails:s,isCreator:O,folderName:o,setFolderName:H,folderDescription:q,setFolderDescription:j,isOnPublicProfile:B,handlePublicProfileToggle:ut,participantsCanAddItems:m,handleParticipantsCanAddItemsToggle:pt,isSavingAlbum:g||Q}),(Q||K.totalFiles>0&&(K.filesUploading>0||K.filesProcessing>0||K.filesComplete<K.totalFiles))&&t.jsx(Xt,{progressTracker:K,isRTL:Ie(n)==="rtl",variant:"detailed",context:"saving",isUploading:Q,showSuccessMessage:!1,showErrorMessage:!0,customMessages:{error:e("Some photos could not be processed. You can continue with the successfully processed photos.")}}),t.jsx("input",{ref:r,id:"file-input",type:"file",accept:"image/*,video/*",multiple:!0,onChange:a=>xe(a,ke),style:{display:"none"}}),s&&O===!0&&wt&&t.jsxs(Ks,{t:e,isRTL:i,children:[(P.length>0||ce)&&t.jsx("div",{style:{marginBottom:"24px"},children:ce?t.jsx("div",{style:{padding:"20px",textAlign:"center",color:"#666",fontSize:"14px"},children:e("Loading existing files...")}):t.jsx(qs,{existingFiles:P,selectedExistingIndices:J,onToggleSelection:ot,onSelectAll:at,onDeselectAll:nt,onDeleteFile:it,disabled:Te,t:e,isRTL:i})}),t.jsx(Gs,{selectedPhotos:f,selectedPhotoIndices:h,onToggleSelection:lt,onSelectAll:dt,onDeselectAll:ct,onRemovePhoto:rt,disabled:Te,t:e,isRTL:i}),t.jsx("div",{style:{marginTop:"24px"},children:t.jsx(Us,{tagsManager:tt,disabled:Te,enhancedLog:k,photoCount:f.length+P.length})})]}),t.jsx(Is,{isSavingAlbum:g,savingProgress:W}),t.jsxs(Jt,{children:[t.jsx(ve,{onClick:bt,disabled:g||Q||ce,children:e(Q?"Uploading...":"Add More Photos")}),O===!0&&t.jsx(ve,{$passwordSet:V!=="NoPassword",onClick:ht,disabled:g||Q||ce,children:xt()}),t.jsx(ve,{$primary:!0,onClick:ft,disabled:g||Q||ce,children:e(g?"Saving Album...":"Save Album")})]}),t.jsx(Vt,{t:e,language:n,usernameManager:S,onSuccess:gt}),t.jsx(ws,{isOpen:X,onClose:mt,initialOption:V,initialPassword:D})]}),t.jsx(ys,{debugMessages:te,t:e,isRTL:i,textDirection:i?"rtl":"ltr"})]})]})},Js=()=>t.jsx(jt,{children:t.jsx(Hs,{})});kt.createRoot(document.getElementById("root")).render(t.jsx(Js,{}));
