...
`,Qt=()=>{const[t,i]=c.useState(!1);return c.useEffect(()=>{const s=()=>{const u="ontouchstart"in window||navigator.maxTouchPoints&&navigator.maxTouchPoints>0||navigator.msMaxTouchPoints&&navigator.msMaxTouchPoints>0;i(u)};s();const a=()=>{s()};return window.addEventListener("resize",a),()=>{window.removeEventListener("resize",a)}},[]),t},yi=xe.memo(({tag:t,isApplied:i,isDisplayed:s,isBeingDeleted:a,disabled:u,onTagClick:g,onDeleteTag:r,getTagDisplayText:o})=>{const{t:l}=ue(),[f,b]=c.useState(!1),x=Qt(),p=x?s&&!u&&!a:f&&s&&!u&&!a;return e.jsxs(Kt,{$isApplied:i,$isDisplayed:s,$isBeingDeleted:a,disabled:u,onClick:()=>g(t),onMouseEnter:()=>!x&&s&&b(!0),onMouseLeave:()=>!x&&s&&b(!1),children:[e.jsx("span",{style:{paddingRight:p?"20px":"0"},children:o(t)}),p&&e.jsx(Ht,{$isMobile:x,onClick:n=>{n.stopPropagation(),r(t.id)},disabled:a,title:l("Delete tag"),children:"×"})]})}),vi=xe.memo(({subtag:t,isApplied:i,isBeingDeleted:s,disabled:a,onSubtagClick:u,onDeleteSubtag:g})=>{const{t:r}=ue(),[o,l]=c.useState(!1),f=Qt(),b=f?i&&!a&&!s:o&&i&&!a&&!s;return e.jsxs(hi,{$isApplied:i,$isBeingDeleted:s,disabled:a,onClick:()=>u(t),onMouseEnter:()=>!f&&i&&l(!0),onMouseLeave:()=>!f&&i&&l(!1),children:[e.jsx("span",{style:{paddingRight:b?"20px":"0"},children:t.subtagTitle}),b&&e.jsx(Ht,{$isMobile:f,onClick:x=>{x.stopPropagation(),g(t.id)},disabled:s,title:r("Delete subtag"),children:"×"})]})}),Vt=({value:t,onChange:i,onSubmit:s,onCancel:a,isSubmitting:u,placeholder:g="Enter tag name..."})=>{const{t:r}=ue(),o=c.useRef(null);c.useEffect(()=>{o.current&&o.current.focus()},[]);const l=f=>{f.key==="Enter"?s():f.key==="Escape"&&a()};return e.jsxs(bi,{children:[e.jsx(wi,{ref:o,type:"text",value:t,onChange:f=>i(f.target.value),onKeyDown:l,placeholder:r(g),disabled:u}),e.jsx(ft,{onClick:s,disabled:!t.trim()||u,title:r("Add (Enter)"),children:u?"...":"✓"}),e.jsx(ft,{onClick:a,disabled:u,title:r("Cancel (Escape)"),children:"×"})]})},Yt=xe.memo(({tagsManager:t,disabled:i=!1,enhancedLog:s})=>{const{t:a}=ue(),{tags:u,displayedTagId:g,isLoadingTags:r,tagIdBeingDeleted:o,isAddingNewTag:l,newTagTitle:f,isSubmittingNewTag:b,toggleTagOnSelectedFiles:x,setDisplayedTag:p,isTagAppliedToSelected:n,deleteTag:P,startAddingNewTag:W,cancelAddingNewTag:D,submitNewTag:j,setNewTagTitle:V,getAppliedTagsForSelected:ee,hasSelectedFiles:y}=t;if(!y())return null;const L=xe.useCallback(G=>{if(!n(G))return G.tagTitle;const q=ee().find($=>$.tagTitle===G.tagTitle);if(!q||q.subtags.length===0)return G.tagTitle;const m=q.subtags.map($=>$.subtagTitle).join(" || ");return a("{{tagTitle}}  |  {{subtags}}",{tagTitle:G.tagTitle,subtags:m})},[n,ee,a]);xe.useEffect(()=>{const G=u.filter(Q=>n(Q)),U=ee();s(`TagsDisplay render - ${G.length} tags applied to all selected files`),s("Applied tags with subtags:",U)},[u,n,ee,s]);const te=G=>{if(i)return;const U=n(G);s(`Tag "${G.tagTitle}" clicked - current state: ${U?"applied to all":"not applied to all"}`),x(G),G.subtags&&G.subtags.length>0&&p(U?null:G.id),s(`After toggle - new state: ${U?"removed from all":"applied to all"}`)},X=async G=>{if(i)return;s(`Delete tag initiated: ${G}`);const U=await P(G);s(U?`Tag successfully deleted: ${G}`:`Failed to delete tag: ${G}`)},R=async()=>{await j()||s("Failed to submit new tag")},ie=xe.useMemo(()=>[...u].sort((G,U)=>G.points!==U.points?U.points-G.points:U.updatedAt-G.updatedAt),[u]);return e.jsxs(mi,{children:[e.jsxs(Ut,{children:[e.jsx(Gt,{children:a("Apply tags to selected files")}),e.jsx(Wt,{children:r?e.jsx(xi,{children:a("Loading tags...")}):e.jsxs(e.Fragment,{children:[ie.map(G=>{const U=n(G);return e.jsx(yi,{tag:G,isApplied:U,isDisplayed:g===G.id,isBeingDeleted:o===G.id,disabled:i,onTagClick:te,onDeleteTag:X,getTagDisplayText:L},G.id)}),l?e.jsx(Vt,{value:f,onChange:V,onSubmit:R,onCancel:D,isSubmitting:b,placeholder:a("Enter tag name...")}):e.jsx(Jt,{disabled:i,onClick:W,children:a("+ Add Tag")}),ie.length===0&&!l&&e.jsx(qt,{children:a("No tags available")})]})})]}),g&&e.jsx(Ti,{tagsManager:t,disabled:i,enhancedLog:s}),e.jsx("div",{style:{marginTop:"24px",padding:"20px 24px",background:"linear-gradient(135deg, #e7f3ff 0%, #f0f8ff 100%)",borderRadius:"12px",fontSize:"13px",color:"#0c5aa6",border:"1px solid #b3d9ff",boxShadow:"0 4px 12px rgba(0, 123, 255, 0.08)"},children:e.jsxs("div",{style:{lineHeight:"2.2"},children:[e.jsxs("div",{style:{marginBottom:"8px"},children:[e.jsx("strong",{style:{color:"#28a745"},children:"🟢"}),"  ",a("Most recently clicked tag (showing subtags)")]}),e.jsxs("div",{style:{marginBottom:"8px"},children:[e.jsx("strong",{style:{color:"#333333"},children:"⚫"}),"  ",a("Applied to selected files")]}),e.jsxs("div",{children:[e.jsx("strong",{style:{color:"#6c757d"},children:"⚪"}),"  ",a("Available but not applied to all selected files")]})]})})]})}),Ti=xe.memo(({tagsManager:t,disabled:i=!1,enhancedLog:s})=>{var X;const{t:a}=ue(),{displayedTagId:u,subtagIdBeingDeleted:g,isAddingNewSubtag:r,newSubtagTitle:o,isSubmittingNewSubtag:l,toggleSubtagOnSelectedFiles:f,isSubtagAppliedToSelected:b,deleteSubtag:x,startAddingNewSubtag:p,cancelAddingNewSubtag:n,submitNewSubtag:P,setNewSubtagTitle:W,tags:D}=t,j=u?((X=D.find(R=>R.id===u))==null?void 0:X.subtags)||[]:[],V=D.find(R=>R.id===u),ee=R=>{i||(s(`Subtag "${R.subtagTitle}" clicked - current state: ${b(R)?"applied to all":"not applied to all"}`),f(R))},y=async R=>{if(i)return;s(`Delete subtag initiated: ${R}`);const ie=await x(R);s(ie?`Subtag successfully deleted: ${R}`:`Failed to delete subtag: ${R}`)},L=async()=>{await P()||s("Failed to submit new subtag")};if(!V)return null;const te=xe.useMemo(()=>[...j].sort((R,ie)=>R.points!==ie.points?ie.points-R.points:ie.updatedAt-R.updatedAt),[j]);return e.jsxs(Ut,{children:[e.jsx(Gt,{children:a('Subtags for "{{tagTitle}}"',{tagTitle:V.tagTitle})}),e.jsxs(Wt,{children:[te.map(R=>e.jsx(vi,{subtag:R,isApplied:b(R),isBeingDeleted:g===R.id,disabled:i,onSubtagClick:ee,onDeleteSubtag:y},R.id)),r?e.jsx(Vt,{value:o,onChange:W,onSubmit:L,onCancel:n,isSubmitting:l,placeholder:a("Enter subtag name...")}):e.jsx(Jt,{disabled:i,onClick:p,children:a("+ Add Subtag")}),te.length===0&&!r&&e.jsx(qt,{children:a("No subtags available")})]})]})}),Si=({photoTags:t,isSelected:i=!1,onToggleSelection:s,fileName:a,showFileName:u=!1})=>{const{t:g}=ue();c.useEffect(()=>{const b="photo-tagging-animations";if(typeof document<"u"&&!document.getElementById(b)){const x=document.createElement("style");x.id=b,x.textContent=`
    ...
    `,document.head.appendChild(i)},[])},gt={traditional:{padding:"20px",border:"2px dashed #007bff",borderRadius:"12px",backgroundColor:"#fff",boxShadow:"0 2px 8px rgba(0, 0, 0, 0.04)"},horizontal:{display:"flex",overflowX:"auto",gap:"16px",padding:"20px",border:"2px dashed #007bff",borderRadius:"12px",backgroundColor:"#fff",boxShadow:"0 2px 8px rgba(0, 0, 0, 0.04)",scrollbarWidth:"thin",scrollbarColor:"#007bff #f8f9fa",scrollBehavior:"smooth",WebkitOverflowScrolling:"touch"}},mt={traditional:{display:"flex",flexDirection:"column",gap:"8px",minWidth:"0"},horizontal:{display:"flex",flexDirection:"column",gap:"8px",minWidth:"180px",maxWidth:"180px",flexShrink:0}},et=xe.memo(({selectedPhotos:t,selectedPhotoIndices:i,isSavingAlbum:s,onRemovePhoto:a,onTogglePhotoSelection:u,photoTagsMap:g,columns:r="1",isMultipleAlbumMode:o=!1})=>{const{t:l}=ue();$i();const f=c.useMemo(()=>{if(o&&r==="horizontal")return gt.horizontal;const p=parseInt(r,10),n=isNaN(p)||p<1?1:Math.min(p,5);return{...gt.traditional,display:"grid",gridTemplateColumns:`repeat(${n}, 1fr)`,gap:"16px"}},[o,r]),b=c.useMemo(()=>o&&r==="horizontal"?mt.horizontal:mt.traditional,[o,r]),x=c.useMemo(()=>o&&r==="horizontal"?"photo-card-horizontal":"photo-card-traditional",[o,r]);return t.length===0?null:e.jsx(e.Fragment,{children:e.jsx("div",{style:f,className:"photo-grid",children:t.map((p,n)=>{var D,j;const P=i.has(n),W=g.get(n)||[];return e.jsxs("div",{style:b,children:[e.jsxs(Ws,{"data-selected":P?"true":"false",className:`${x} ${P?"selected":""}`,onClick:()=>u(n),children:[P&&!s&&e.jsx("button",{onClick:V=>{V.stopPropagation(),confirm(l("Are you sure you want to remove this photo?"))&&a(n)},className:"photo-delete-button",title:l("Remove photo"),children:"×"}),p.status!=="complete"&&e.jsx(Ks,{$status:p.status,children:p.status==="error"?"✕":p.status==="uploading"?"↑":p.status==="processing"?"⚙️":"•"}),e.jsxs(Hs,{className:`media-preview ${P?"selected":""}`,children:[p.type==="video"||(D=p.type)!=null&&D.startsWith("video")?e.jsx(qs,{src:p.s3PreviewUrl,controls:!0,className:"media-item"}):e.jsx(Js,{src:p.s3PreviewUrl,alt:p.fileName,className:"media-item"}),(p.status==="uploading"||p.status==="processing")&&e.jsx(At,{$bottom:"4px",$left:"4px",$right:"4px",$height:"4px",children:e.jsx(jt,{$progress:p.progress,$status:p.status})})]}),e.jsxs("div",{className:"file-info-overlay",children:[(j=p.type)!=null&&j.startsWith("video")?l("Video"):l("Image"),p.size&&l(" • {{size}} MB",{size:(p.size/1024/1024).toFixed(1)}),p.duration&&l(" • {{duration}}s",{duration:p.duration})]}),o&&r==="horizontal"&&P&&e.jsx("div",{className:"selection-indicator",children:l("SELECTED")}),p.status==="error"&&p.errorMessage&&e.jsx(Qs,{$type:"error",children:l("Error: {{message}}",{message:p.errorMessage.length>40?p.errorMessage.substring(0,37)+"...":p.errorMessage})})]}),e.jsx("div",{className:`photo-info ${o&&r==="horizontal"?"horizontal":"traditional"}`,children:e.jsx(Si,{photoTags:W,isSelected:P,onToggleSelection:()=>u(n),fileName:p.originalFileName||p.fileName,showFileName:!0})})]},n)})})})});et.displayName="PhotoHandler";const Xt=xe.memo(({isSavingAlbum:t,savingProgress:i})=>{const{t:s}=ue();return t?e.jsxs(Ct,{children:[e.jsx(Vs,{children:s("Saving Album")}),e.jsx(Ys,{id:"saveProgressText",children:s("Moving files...")}),e.jsx(At,{children:e.jsx(jt,{id:"saveProgress",$progress:i/100})})]}):null});Xt.displayName="SavingProgressComponent";const Zt=xe.memo(({showFolderDetails:t,isCreator:i,folderName:s,setFolderName:a,folderDescription:u,setFolderDescription:g,isSavingAlbum:r})=>{const{t:o}=ue();return!t||i!==!0?null:e.jsxs(Ct,{children:[e.jsxs(ct,{children:[e.jsx(ut,{htmlFor:"folderName",children:o("Album Name")}),e.jsx(Xs,{id:"folderName",type:"text",value:s,onChange:l=>a(l.target.value),placeholder:o("e.g. Family Vacation in Kyoto"),disabled:r})]}),e.jsxs(ct,{children:[e.jsx(ut,{htmlFor:"folderDescription",children:o("Album Description")}),e.jsx(Zs,{id:"folderDescription",value:u,onChange:l=>g(l.target.value),placeholder:o("e.g. what's special about this album"),rows:4,disabled:r})]})]})});Zt.displayName="FolderDetailsComponent";const Pi=()=>{c.useEffect(()=>{if(typeof document>"u")return;const t="existing-files-animations";if(document.getElementById(t))return;const i=document.createElement("style");i.id=t,i.textContent=`
      @keyframes subtlePulse {
        0%, 100% { 
          opacity: 1;
          transform: scale(1);
    ...
    `,document.head.appendChild(i)},[])},Ii=({existingFiles:t,selectedExistingIndices:i,onToggleSelection:s,onSelectAll:a,onDeselectAll:u,onDeleteFile:g,disabled:r,isCreator:o,participantsCanDeleteItems:l,existingFileTagsMap:f,t:b,isRTL:x})=>(Pi(),t.length===0?null:e.jsxs("div",{style:{marginBottom:"32px",direction:x?"rtl":"ltr"},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"24px",flexDirection:x?"row-reverse":"row"},children:[e.jsx("div",{children:e.jsx("h3",{style:{fontSize:"16px",fontWeight:"600",color:"#333",margin:0},children:b("Existing Files ({count})").replace("{count}",t.length.toString())})}),e.jsx("div",{style:{display:"flex",gap:"8px",flexDirection:x?"row-reverse":"row"},children:e.jsx("button",{style:{padding:"6px 12px",fontSize:"12px",border:"1px solid #ddd",borderRadius:"4px",backgroundColor:r?"#f8f9fa":"#fff",color:r?"#999":"#333",cursor:r?"not-allowed":"pointer",transition:"all 0.2s ease"},onClick:i.size>0?u:a,disabled:r,children:i.size>0?b("Done Tagging Selected"):b("Select All")})})]}),e.jsx("div",{className:"existing-files-grid",children:t.map((p,n)=>{const P=i.has(n),W=f.get(n)||[];return e.jsxs("div",{className:"existing-file-item",children:[e.jsxs("div",{className:`existing-file-card ${P?"selected":""}`,onClick:()=>!r&&s(n),children:[e.jsx(Gs,{thumbnailDataKey:p.thumbnailDataKey,dataKey:p.dataKey,alt:b("Existing file"),style:{width:"100%",height:"100%",objectFit:"cover"}}),P&&!r&&(o===!0||l)&&e.jsx("button",{onClick:D=>{D.stopPropagation(),confirm(b("Are you sure you want to remove this file?"))&&g(n)},className:"delete-button",title:b("Remove file"),children:"×"}),p.dataInBytes>0&&e.jsx("div",{className:"file-size",children:b("{size} MB").replace("{size}",(p.dataInBytes/(1024*1024)).toFixed(1))}),p.durationInSeconds&&e.jsx("div",{className:"file-duration",children:b("{minutes}:{seconds}").replace("{minutes}",Math.floor(p.durationInSeconds/60).toString()).replace("{seconds}",String(Math.floor(p.durationInSeconds%60)).padStart(2,"0"))})]}),e.jsxs("div",{className:"file-info",children:[p.fileName&&e.jsx("div",{className:`file-name ${P?"selected":""}`,children:p.fileName}),e.jsx("div",{className:"file-tags",children:W.length>0?e.jsx("div",{className:"tags-display",children:e.jsxs("div",{className:"tags-content",children:[e.jsx("span",{className:"tag-icon",children:"🏷️"}),e.jsx("span",{className:"tags-text",children:W.map(D=>{if(D.subtags.length>0){const j=D.subtags.map(V=>V.subtagTitle).join(", ");return b("{tagTitle}: {subtags}").replace("{tagTitle}",D.tagTitle).replace("{subtags}",j)}return D.tagTitle}).join(" • ")})]})}):P?e.jsx("div",{style:{background:"white",border:"1px solid #007bff",color:"#007bff",fontWeight:"600",fontSize:"11px",fontStyle:"normal",padding:"8px 12px",borderRadius:"6px",boxShadow:"0 2px 8px rgba(0, 123, 255, 0.2)",animation:"subtlePulse 2.5s infinite"},children:e.jsxs("span",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:"4px"},children:[e.jsx("span",{children:"👇"})," ",b("Scroll down to select tags")]})}):null})]})]},`existing-${n}-${p.dataKey}`)})})]})),Ai=({selectedPhotos:t,selectedPhotoIndices:i,onToggleSelection:s,onSelectAll:a,onDeselectAll:u,onRemovePhoto:g,onDeleteAll:r,disabled:o,photoTagsMap:l,columns:f,setColumns:b,t:x,isRTL:p})=>t.length===0?null:e.jsxs("div",{style:{marginBottom:"32px",direction:p?"rtl":"ltr"},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"16px",flexDirection:p?"row-reverse":"row"},children:[e.jsx("h3",{style:{fontSize:"16px",fontWeight:"600",color:"#333",margin:0},children:x("New Files ({count})").replace("{count}",t.length.toString())}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:p?"flex-start":"flex-end",gap:"8px"},children:[e.jsxs("div",{style:{display:"flex",gap:"8px",flexDirection:p?"row-reverse":"row"},children:[e.jsx("button",{className:"control-button",onClick:i.size>0?u:a,disabled:o,children:i.size>0?x("Done Tagging Selected"):x("Select All")}),i.size===0&&e.jsx("button",{className:"control-button danger",onClick:r,disabled:o,children:x("Delete All")})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"6px",flexDirection:p?"row-reverse":"row"},children:[e.jsx("label",{className:"columns-label",children:x("Columns:")}),e.jsxs("select",{value:f,onChange:n=>b(n.target.value),className:"columns-select",children:[e.jsx("option",{value:"1",children:"1"}),e.jsx("option",{value:"2",children:"2"}),e.jsx("option",{value:"3",children:"3"}),e.jsx("option",{value:"4",children:"4"}),e.jsx("option",{value:"5",children:"5"})]})]})]})]}),e.jsx(et,{selectedPhotos:t,selectedPhotoIndices:i,isSavingAlbum:o,onRemovePhoto:g,onTogglePhotoSelection:s,onSelectAllPhotos:a,onDeselectAllPhotos:u,hideHeader:!0,photoTagsMap:l,columns:f})]}),ji=A.button`
  padding: 8px;
  border: 1px solid #6c757d;
  border-radius: 6px;
  background: transparent;
