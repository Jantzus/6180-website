import{d as N,u as ve,r as $,j as t,g as de,h as L,L as K,i as pe,s as Oe,m as Ue,f as ie,k as Me,l as Be,n as ze,a as qe,R as We,I as Ge}from"./utils-BHKWecq1.js";import{S as Je,P as Ve,e as He,f as Ke,g as Qe,V as Ye,h as Xe,i as Se,j as ye,F as Ze,M as Le,R as et,C as $e,k as tt,l as rt,m as me,n as ge,o as st,p as it,T as be,q as he,r as Pe,s as xe,G as ot,A as at,H as lt,t as nt,u as dt,B as le}from"./styled-components-CdDLTMrE.js";import{u as ut,U as ct}from"./useUsernameManagement-vYghANWS.js";import{u as ft,U as pt}from"./useFileUploadProcessor-C6Aglvvi.js";import{L as mt,D as gt}from"./DebugLog-CzQZL26s.js";const bt=N.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,St=({isOpen:i,onClose:S,initialOption:v="NoPassword",initialPassword:I=""})=>{const{t:s,language:R}=ve(),C=de(R)==="rtl",[F,A]=$.useState(v),[T,U]=$.useState(I);if($.useEffect(()=>{i&&(A(v),U(I))},[i,v,I]),!i)return null;const c=T.trim()==="",r=E=>{E!=="NoPassword"&&c||A(E)},G=E=>{E.target===E.currentTarget&&S()};return t.jsx(bt,{onClick:G,children:t.jsxs(ht,{children:[t.jsx(Pt,{children:s("Album Password Policy")}),t.jsxs(xt,{isRTL:C,children:[t.jsx(Ie,{children:s("Enter a password for this album.")}),t.jsx(It,{type:"text",placeholder:s("Enter password"),value:T,onChange:E=>U(E.target.value),autoCapitalize:"none",autoComplete:"off",spellCheck:"false",autoCorrect:"off"}),t.jsx(Ie,{children:s("Select password restrictions.")}),t.jsxs(wt,{children:[t.jsxs(te,{disabled:c,children:[t.jsx(re,{type:"radio",name:"protection",id:"notVisible",checked:F==="NotVisible",onChange:()=>{},disabled:c,onClick:()=>!c&&r("NotVisible")}),t.jsxs(se,{htmlFor:"notVisible",disabled:c,children:[s("Password Required To See Or Save"),c&&t.jsx(ne,{children:s("Password required")})]})]}),t.jsxs(te,{disabled:c,children:[t.jsx(re,{type:"radio",name:"protection",id:"watermark",checked:F==="Watermark",onChange:()=>{},disabled:c,onClick:()=>!c&&r("Watermark")}),t.jsxs(se,{htmlFor:"watermark",disabled:c,children:[s("Watermarked And No Saving Without Password"),c&&t.jsx(ne,{children:s("Password required")})]})]}),t.jsxs(te,{disabled:c,children:[t.jsx(re,{type:"radio",name:"protection",id:"cannotBeSaved",checked:F==="CannotBeSaved",onChange:()=>{},disabled:c,onClick:()=>!c&&r("CannotBeSaved")}),t.jsxs(se,{htmlFor:"cannotBeSaved",disabled:c,children:[s("Password Required To Save"),c&&t.jsx(ne,{children:s("Password required")})]})]}),t.jsxs(te,{disabled:!1,children:[t.jsx(re,{type:"radio",name:"protection",id:"noPassword",checked:F==="NoPassword",onChange:()=>{},onClick:()=>r("NoPassword")}),t.jsx(se,{htmlFor:"noPassword",disabled:!1,children:s("No Password")})]})]}),t.jsxs(vt,{children:[t.jsx(we,{onClick:()=>S(),children:s("Cancel")}),t.jsx(we,{onClick:()=>{console.log(`Saving with option: ${F}, password: ${T.length>0?"********":"none"}`),S(F,T)},children:s("Save")})]})]})]})})},yt=`
