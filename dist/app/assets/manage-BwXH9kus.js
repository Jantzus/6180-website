import{d as x,R as de,j as n,I as ue,u as pe,r as l,a as ne,b as ie,h as oe,f as ae,g as me}from"./utils-BM__RYiI.js";import{u as ge}from"./useFolderManagement-DVNXarZa.js";import"./types-CyPfckSQ.js";const fe=()=>{const[e,a]=l.useState(!1),[s,i]=l.useState(null),[p,t]=l.useState(null);return l.useEffect(()=>{a(!0),typeof window<"u"&&i(window),typeof document<"u"&&t(document)},[]),{isClient:e,window:s,document:p}},he=()=>{const[e,a]=l.useState(!1);l.useEffect(()=>{a(!0)},[]);const s=l.useCallback(t=>{if(!e||typeof localStorage>"u")return null;try{return localStorage.getItem(t)}catch{return null}},[e]),i=l.useCallback((t,c)=>{if(!(!e||typeof localStorage>"u"))try{localStorage.setItem(t,c)}catch{}},[e]),p=l.useCallback(t=>{if(!(!e||typeof localStorage>"u"))try{localStorage.removeItem(t)}catch{}},[e]);return{getItem:s,setItem:i,removeItem:p,isClient:e}},ce=()=>{const[e,a]=l.useState("US"),[s,i]=l.useState(!1);l.useEffect(()=>{if(i(!0),!(typeof Intl>"u"))try{const t=Intl.DateTimeFormat().resolvedOptions().timeZone;t.includes("Europe/Amsterdam")?a("NL"):t.includes("Europe/Berlin")?a("DE"):t.includes("Europe/Vienna")?a("AT"):t.includes("Europe/Brussels")?a("BE"):t.includes("Europe/Warsaw")?a("PL"):a("US")}catch{a("US")}},[]);const p=l.useCallback((t,c="USD")=>{if(!s||typeof Intl>"u")return`$${t.toFixed(2)}`;try{return new Intl.NumberFormat("en-US",{style:"currency",currency:c}).format(t)}catch{return`$${t.toFixed(2)}`}},[s]);return{userCountry:e,formatCurrency:p,isClient:s}},ye=()=>{const[e,a]=l.useState(!1);l.useEffect(()=>{a(!0)},[]);const s=l.useCallback(()=>{if(!e||typeof window>"u")return null;try{return new URLSearchParams(window.location.search)}catch{return null}},[e]),i=l.useCallback(()=>{if(!e||typeof window>"u")return null;try{return{origin:window.location.origin,pathname:window.location.pathname}}catch{return null}},[e]),p=l.useCallback(t=>{if(!(!e||typeof window>"u"||typeof document>"u"))try{window.history.replaceState({},document.title||"",t)}catch{}},[e]);return{getURLParams:s,getCurrentURL:i,replaceURL:p,isClient:e}},xe=`
