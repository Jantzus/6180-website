import{d as a,u as m,R as x,j as e,a as h,I as f,r as u,G as b,A as j,H as v,L,b as y,c as k,e as S,B as w,f as E,g}from"./styled-components-vqx_itBo.js";import{g as p}from"./translations-RBkJ9Pxg.js";import{c as H,a as M}from"./utils-u3dSZAoR.js";const I=a.div`
  display: flex;
  align-items: center;
  gap: 8px;
  position: relative;
...
`,C=a.option`
  padding: 5px;
`,T=({className:n,label:o="🌐",variant:s="default"})=>{const{language:r,setLanguage:c,languages:i}=m(),d=x.useMemo(()=>a(B)`
      ${s==="minimal"&&`
        border: none;
