import{f as N,u as we,r as $,j as t,g as ve,i as K,h as ie,S as Oe,P as Ue,l as Me,m as Be,n as ze,V as qe,o as We,p as Se,q as ye,F as Ge,M as Je,s as Ve,k as $e,t as He,v as Ke,w as fe,x as pe,y as Qe,z as Ye,T as me,D as ge,E as be,J as he,R as Xe,I as Ze,G as Le,A as et,H as tt,K as rt,N as st,B as le}from"./styled-components-DtPfDTlN.js";import{u as it,U as ot}from"./useUsernameManagement-CtuR-Y4c.js";import{u as at,U as lt}from"./useFileUploadProcessor-BBrRWQdj.js";import{L as nt,D as dt}from"./DebugLog-DfpuX8IL.js";import{b as L,g as Pe,s as ut,m as ct,d as ft,e as pt,f as mt}from"./utils-GP-Xp91M.js";const gt=N.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,vt=({isOpen:i,onClose:S,initialOption:I="NoPassword",initialPassword:w=""})=>{const{t:s,language:R}=we(),C=ve(R)==="rtl",[F,A]=$.useState(I),[T,U]=$.useState(w);if($.useEffect(()=>{i&&(A(I),U(w))},[i,I,w]),!i)return null;const c=T.trim()==="",r=E=>{E!=="NoPassword"&&c||A(E)},G=E=>{E.target===E.currentTarget&&S()};return t.jsx(gt,{onClick:G,children:t.jsxs(bt,{children:[t.jsx(ht,{children:s("Album Password Policy")}),t.jsxs(Pt,{isRTL:C,children:[t.jsx(xe,{children:s("Enter a password for this album.")}),t.jsx(xt,{type:"text",placeholder:s("Enter password"),value:T,onChange:E=>U(E.target.value),autoCapitalize:"none",autoComplete:"off",spellCheck:"false",autoCorrect:"off"}),t.jsx(xe,{children:s("Select password restrictions.")}),t.jsxs(It,{children:[t.jsxs(te,{disabled:c,children:[t.jsx(re,{type:"radio",name:"protection",id:"notVisible",checked:F==="NotVisible",onChange:()=>{},disabled:c,onClick:()=>!c&&r("NotVisible")}),t.jsxs(se,{htmlFor:"notVisible",disabled:c,children:[s("Password Required To See Or Save"),c&&t.jsx(ne,{children:s("Password required")})]})]}),t.jsxs(te,{disabled:c,children:[t.jsx(re,{type:"radio",name:"protection",id:"watermark",checked:F==="Watermark",onChange:()=>{},disabled:c,onClick:()=>!c&&r("Watermark")}),t.jsxs(se,{htmlFor:"watermark",disabled:c,children:[s("Watermarked And No Saving Without Password"),c&&t.jsx(ne,{children:s("Password required")})]})]}),t.jsxs(te,{disabled:c,children:[t.jsx(re,{type:"radio",name:"protection",id:"cannotBeSaved",checked:F==="CannotBeSaved",onChange:()=>{},disabled:c,onClick:()=>!c&&r("CannotBeSaved")}),t.jsxs(se,{htmlFor:"cannotBeSaved",disabled:c,children:[s("Password Required To Save"),c&&t.jsx(ne,{children:s("Password required")})]})]}),t.jsxs(te,{disabled:!1,children:[t.jsx(re,{type:"radio",name:"protection",id:"noPassword",checked:F==="NoPassword",onChange:()=>{},onClick:()=>r("NoPassword")}),t.jsx(se,{htmlFor:"noPassword",disabled:!1,children:s("No Password")})]})]}),t.jsxs(wt,{children:[t.jsx(Ie,{onClick:()=>S(),children:s("Cancel")}),t.jsx(Ie,{onClick:()=>{console.log(`Saving with option: ${F}, password: ${T.length>0?"********":"none"}`),S(F,T)},children:s("Save")})]})]})]})})},St=`
