import{d as U,u as Se,r as I,j as e,g as Ie,l as V,k as ne,P as Ne,m as ke,O as Oe,n as Re,o as Ue,p as Be,q as Me,s as ie,S as ze,t as qe,v as We,w as Je,x as Ge,y as Ve,z as He,D as Ke,E as Qe,M as Ye,V as Xe,F as Ze,U as Le,J as et,K as tt,N as st,Q as rt,T as it,W as pe,X as me,Y as ot,Z as at,_ as ge,$ as he,a0 as be,a1 as xe,a as lt,I as nt,G as dt,A as ct,H as ut,a2 as ft,a3 as pt,a4 as mt,a5 as gt,a6 as ht,a7 as bt}from"./styled-components-ClhTjOpj.js";import{u as Pe,U as xt}from"./customHooks-BeLQft9M.js";import{L as Pt,D as vt}from"./DebugLog-BcCtoAMU.js";import{b as L,g as ce,s as wt,m as St,d as It,e as yt,f as $t,u as jt,h as Ft,p as _t,i as Ct}from"./utils-B7E7z9GF.js";const At=U.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,Rt=({isOpen:s,onClose:l,initialOption:x="NoPassword",initialPassword:g=""})=>{const{t:i,language:A}=Se(),N=Ie(A)==="rtl",[P,j]=I.useState(x),[k,M]=I.useState(g);if(I.useEffect(()=>{s&&(j(x),M(g))},[s,x,g]),!s)return null;const f=k.trim()==="",r=T=>{T!=="NoPassword"&&f||j(T)},O=T=>{T.target===T.currentTarget&&l()};return e.jsx(At,{onClick:O,children:e.jsxs(Et,{children:[e.jsx(Dt,{children:i("Album Password Policy")}),e.jsxs(Tt,{isRTL:N,children:[e.jsx(ve,{children:i("Enter a password for this album.")}),e.jsx(Nt,{type:"text",placeholder:i("Enter password"),value:k,onChange:T=>M(T.target.value),autoCapitalize:"none",autoComplete:"off",spellCheck:"false",autoCorrect:"off"}),e.jsx(ve,{children:i("Select password restrictions.")}),e.jsxs(kt,{children:[e.jsxs(oe,{disabled:f,children:[e.jsx(ae,{type:"radio",name:"protection",id:"notVisible",checked:P==="NotVisible",onChange:()=>{},disabled:f,onClick:()=>!f&&r("NotVisible")}),e.jsxs(le,{htmlFor:"notVisible",disabled:f,children:[i("Password Required To See Or Save"),f&&e.jsx(de,{children:i("Password required")})]})]}),e.jsxs(oe,{disabled:f,children:[e.jsx(ae,{type:"radio",name:"protection",id:"watermark",checked:P==="Watermark",onChange:()=>{},disabled:f,onClick:()=>!f&&r("Watermark")}),e.jsxs(le,{htmlFor:"watermark",disabled:f,children:[i("Password Required To Remove Watermark Or Save"),f&&e.jsx(de,{children:i("Password required")})]})]}),e.jsxs(oe,{disabled:f,children:[e.jsx(ae,{type:"radio",name:"protection",id:"cannotBeSaved",checked:P==="CannotBeSaved",onChange:()=>{},disabled:f,onClick:()=>!f&&r("CannotBeSaved")}),e.jsxs(le,{htmlFor:"cannotBeSaved",disabled:f,children:[i("Password Required To Save"),f&&e.jsx(de,{children:i("Password required")})]})]}),e.jsxs(oe,{disabled:!1,children:[e.jsx(ae,{type:"radio",name:"protection",id:"noPassword",checked:P==="NoPassword",onChange:()=>{},onClick:()=>r("NoPassword")}),e.jsx(le,{htmlFor:"noPassword",disabled:!1,children:i("No Password")})]})]}),e.jsxs(Ot,{children:[e.jsx(we,{onClick:()=>l(),children:i("Cancel")}),e.jsx(we,{onClick:()=>{console.log(`Saving with option: ${P}, password: ${k.length>0?"********":"none"}`),l(P,k)},children:i("Save")})]})]})]})})},Ut=`
