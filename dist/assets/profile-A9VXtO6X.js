import{i as o,ae as te,j as e,R as oe,I as re,l as Y,r as d,u as z,k as q,aa as ie,ab as ne,G as se,g as G}from"./styled-components-CN2E2_K9.js";import{c as M,t as ae,h as X,i as N}from"./utils-BLSZNlK8.js";import{S as le,L as de}from"./LazyImage-C1hq5A2q.js";import{C as ce,a as pe}from"./Modals-DPt9ZNEv.js";const fe=o.div`
  margin-bottom: 24px;
  text-align: center;
...
`,Ue=o.div`
  ...
  margin: 0 auto;
  padding: 40px 20px;
`,ze=({username:t,isCurrentUser:h,isRTL:C})=>{const{t:u}=z(),[m,f]=d.useState(!1),c=s=>{s.preventDefault(),s.stopPropagation(),f(!m)};return d.useEffect(()=>{const s=()=>{m&&f(!1)};return document.addEventListener("click",s),()=>{document.removeEventListener("click",s)}},[m]),e.jsxs(fe,{isRTL:C,children:[e.jsxs(ue,{isRTL:C,children:[e.jsxs(he,{onClick:c,children:[e.jsx(xe,{children:t?t.charAt(0).toUpperCase():"?"}),e.jsx(ge,{children:t||u("User Profile")}),e.jsx(me,{})]}),m&&e.jsxs(be,{children:[e.jsx(K,{hasBorder:!0,onClick:()=>{alert(u("Bio feature is coming soon! Stay tuned for updates where you can share more about yourself."))},children:e.jsx("span",{children:"Bio"})}),e.jsx(K,{hasBorder:!0,onClick:()=>{alert(u("Email feature is coming soon! Soon you will be able to share your email with connections."))},children:e.jsx("span",{children:"E-mail"})}),e.jsx(K,{onClick:()=>{alert(u("Add Contact feature is coming soon! You will be able to add this person as a contact on 6180."))},children:e.jsx("span",{children:"Contact On 6180"})})]})]}),h&&e.jsx(we,{children:e.jsx("p",{children:u("This is how others see your public profile")})})]})},Be=({folder:t,isOwner:h,hasAddPhotoPermission:C,cognitoUsername:u,openFilePicker:m,updateProfileIds:f})=>{const{t:c,language:s}=z(),b=G(s)==="rtl",[v,r]=d.useState((t.profileIds||[]).includes(`${u}_____Public____Profile`)),[g,P]=d.useState(!1),[w,A]=d.useState(!1),R=`https://6180.io/photos.html?id=${X(t.folderId).replace(/-/g,"")}`,_=()=>{navigator.clipboard.writeText(R).then(()=>{P(!1),A(!0)}).catch(i=>{console.error("Failed to copy link:",i),alert(c("Failed to copy link"))})},k=async i=>{var I,E,D;if(i.preventDefault(),i.stopPropagation(),!u){alert(c("You must be logged in to perform this action"));return}try{const S=await M();if(!S){console.error("Authentication failed");return}const $=`${u}_____Public____Profile`,T=[...t.profileIds||[]];if(v){const l=T.indexOf($);l>-1&&T.splice(l,1)}else T.push($);const n=await(await fetch(q,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${S}`},body:JSON.stringify({query:`
      ...
      `;let y;if(w)try{const F=await M();F&&(y=await(await fetch(q,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${F}`},body:JSON.stringify({query:x,variables:l})})).json())}catch(F){console.error("Error fetching private data:",F)}if(y||(y=await(await fetch(ie,{method:"POST",headers:{"Content-Type":"application/json","x-api-key":ne},body:JSON.stringify({query:x,variables:l})})).json()),(a=(n=y==null?void 0:y.data)==null?void 0:n.fetchRelations)!=null&&a.items){const V=y.data.fetchRelations.items.map(B=>{var W,J;const j=B.folder,ee=((J=(W=j==null?void 0:j.fileReferencesPage)==null?void 0:W.items)==null?void 0:J.map(O=>O.file))||[];return{folderPositionId:B.id,folderId:j.id,folderName:j.folderName,folderDescription:j.folderDescription,folderPassword:j.folderPassword,creatorId:j.creatorId,createdAt:j.createdAt,updatedAt:j.updatedAt,files:ee.filter(O=>O&&O.dataKey),profileIds:B.profileIds||[]}});r(V)}}catch(p){console.error("Error fetching folders:",p),b(I("Failed to fetch profile data"))}finally{c(!1)}},$=n=>{var p;const a=Array.from(n.target.files||[]);a.length&&(n.target.value&&((p=n.target.files)!=null&&p.length)&&(localStorage.setItem(Y.SELECTED_PHOTOS,JSON.stringify(a.map(l=>({name:l.name,size:l.size,type:l.type})))),_?window.location.href=`/save-album.html?folderId=${encodeURIComponent(_)}`:window.location.href="/save-album.html"),n.target&&(n.target.value=""))},T=n=>{var a;k(n),(a=t.current)==null||a.click()},H=d.useMemo(()=>g?v.filter(n=>{var l,x;const a=(l=n.folderName)==null?void 0:l.toLowerCase().includes(g.toLowerCase()),p=(x=n.folderDescription)==null?void 0:x.toLowerCase().includes(g.toLowerCase());return a||p}):v,[v,g]),Q=w;return e.jsxs(e.Fragment,{children:[e.jsx(se,{}),e.jsxs(Ue,{children:[e.jsx(ze,{username:u||I("User"),isCurrentUser:i,isRTL:D}),e.jsx(le,{searchQuery:g,setSearchQuery:P,t:I,isRTL:D}),f&&e.jsx(Oe,{children:e.jsx("p",{children:I("Loading albums...")})}),s&&e.jsx(Ne,{children:e.jsx("p",{children:s})}),!f&&!s&&e.jsx(Ke,{folders:H,setFolders:r,isOwner:i,hasAddPhotoPermission:Q,cognitoUsername:L,openFilePicker:T}),w&&e.jsx(Me,{onFileSelection:$,ref:t})]})]})};oe.createRoot(document.getElementById("root")).render(e.jsx(re,{initialLanguage:localStorage.getItem(Y.LANGUAGE)||"en",children:e.jsx(Ge,{})}));
