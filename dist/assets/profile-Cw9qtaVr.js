import{d as o,R as te,j as e,u as z,r as d,g as G,k as Y,a as oe,I as re,l as q,a9 as ie,aa as ne,G as se,A as ae}from"./styled-components-TLcRmuEy.js";import{h as X,i as N,c as M,t as le}from"./utils-Bp6O1SOV.js";import{L as de,S as ce}from"./LazyImage-D1mw5-KI.js";import{C as pe,a as ue}from"./Modals-ZMMoxRDS.js";const fe=o.div`
  margin-bottom: 24px;
  text-align: center;
...
`;o.div`
  ...
  margin: 0 auto;
  padding: 40px 20px;
`;const ze=({username:t,isCurrentUser:h,isRTL:C})=>{const{t:f}=z(),[m,u]=d.useState(!1),c=s=>{s.preventDefault(),s.stopPropagation(),u(!m)};return d.useEffect(()=>{const s=()=>{m&&u(!1)};return document.addEventListener("click",s),()=>{document.removeEventListener("click",s)}},[m]),e.jsxs(fe,{isRTL:C,children:[e.jsxs(he,{isRTL:C,children:[e.jsxs(xe,{onClick:c,children:[e.jsx(ge,{children:t?t.charAt(0).toUpperCase():"?"}),e.jsx(me,{children:t||f("User Profile")}),e.jsx(be,{})]}),m&&e.jsxs(we,{children:[e.jsx(K,{hasBorder:!0,onClick:()=>{alert(f("Bio feature is coming soon! Stay tuned for updates where you can share more about yourself."))},children:e.jsx("span",{children:"Bio"})}),e.jsx(K,{hasBorder:!0,onClick:()=>{alert(f("Email feature is coming soon! Soon you will be able to share your email with connections."))},children:e.jsx("span",{children:"E-mail"})}),e.jsx(K,{onClick:()=>{alert(f("Add Contact feature is coming soon! You will be able to add this person as a contact on 6180."))},children:e.jsx("span",{children:"Contact On 6180"})})]})]}),h&&e.jsx(Ie,{children:e.jsx("p",{children:f("This is how others see your public profile")})})]})},Be=({folder:t,isOwner:h,hasAddPhotoPermission:C,cognitoUsername:f,openFilePicker:m,updateProfileIds:u})=>{const{t:c,language:s}=z(),b=G(s)==="rtl",[v,r]=d.useState((t.profileIds||[]).includes(`${f}_____Public____Profile`)),[g,P]=d.useState(!1),[w,A]=d.useState(!1),R=`https://6180.io/photos.html?id=${X(t.folderId).replace(/-/g,"")}`,_=()=>{navigator.clipboard.writeText(R).then(()=>{P(!1),A(!0)}).catch(i=>{console.error("Failed to copy link:",i),alert(c("Failed to copy link"))})},k=async i=>{var I,E,S;if(i.preventDefault(),i.stopPropagation(),!f){alert(c("You must be logged in to perform this action"));return}try{const T=await M();if(!T){console.error("Authentication failed");return}const $=`${f}_____Public____Profile`,F=[...t.profileIds||[]];if(v){const l=F.indexOf($);l>-1&&F.splice(l,1)}else F.push($);const n=await(await fetch(Y,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${T}`},body:JSON.stringify({query:`
