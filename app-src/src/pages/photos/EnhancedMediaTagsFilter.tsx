...
type EnhancedMediaTagsFilterProps = {
  mediaItems: MediaItem[];
  onFilterChange: (filteredItems: MediaItem[]) => void;
  resetFilter: () => void;
};

export const EnhancedMediaTagsFilter: React.FC<EnhancedMediaTagsFilterProps> = ({
  mediaItems,
  onFilterChange,
  resetFilter,
}) => {
  ...
  console.log('🎯 EnhancedMediaTagsFilter received props:', {
  ...
  useEffect(() => {
    console.log('🏷️ EnhancedMediaTagsFilter: Starting tag extraction from mediaItems:', mediaItems.length);
  ...
  console.log('🎯 EnhancedMediaTagsFilter render decision:', {
  ...
  if (!hasTags) {
    console.log('❌ EnhancedMediaTagsFilter: No tags found, returning null');
    return null;
  }
  
  console.log('✅ EnhancedMediaTagsFilter: Rendering with tags');
