...
const PhotoHandler: React.FC<PhotoHandlerProps> = ({ 
  selectedPhotos, 
  isSavingAlbum, 
  onRemovePhoto 
}) => {
...
const ProgressTrackerComponent: React.FC<ProgressTrackerComponentProps> = ({ progressTracker }) => {
  const { t } = useTranslation();
...
interface SavingProgressComponentProps {
  isSavingAlbum: boolean;
  savingProgress: number;
}

const SavingProgressComponent: React.FC<SavingProgressComponentProps> = ({ isSavingAlbum, savingProgress }) => {
  const { t } = useTranslation();
...
interface SubAlbumInfoProps {
  isSubAlbum: boolean;
  selectedPhotos: SelectedPhoto[];
  selectedFileIds: string[];
}

const SubAlbumInfo: React.FC<SubAlbumInfoProps> = ({ isSubAlbum, selectedPhotos, selectedFileIds }) => {
  const { t } = useTranslation();
...
interface FolderDetailsComponentProps {
...
const FolderDetailsComponent: React.FC<FolderDetailsComponentProps> = ({
  showFolderDetails,
  isCreator,
  folderName,
  setFolderName,
